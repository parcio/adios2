...
JuleaDB_DO_Writer::~JuleaDB_DO_Writer()
{
    // DoClose();
    // if (m_Verbosity == 5)
    if (m_Verbosity == 5)
 ...
 */
size_t JuleaDB_DO_Writer::CurrentStep() const
{
 ...
 */
void JuleaDB_DO_Writer::EndStep()
{
 ...
 * available.
 */
void JuleaDB_DO_Writer::PerformPuts()
{
    if (m_Verbosity == 5)
    {
        std::cout << "Julea DB Writer " << m_WriterRank
...
void JuleaDB_DO_Writer::Flush(const int transportIndex)
{
...
void JuleaDB_DO_Writer::InitDB() { InitDB_DO_Schemas(); }

/**TODO needed?
 * see BP3Base InitParameters
 */
void JuleaDB_DO_Writer::InitParameters()
{
 ...
 */
void JuleaDB_DO_Writer::InitVariables()
{
 ...
 * @param transportIndex [description]
 */
void JuleaDB_DO_Writer::DoClose(const int transportIndex)
{
    if (m_Verbosity == 5)
    {
...
void JuleaDB_DO_Writer::DoFlush(const bool isFinal, const int transportIndex)
{
    if (m_Verbosity == 5)
    {
 ...
 */
void JuleaDB_DO_Writer::PutAttributes(core::IO &io)
{
...
void JuleaDB_DO_Writer::InitParameterFlushStepsCount(const std::string value)
{
