...
JuleaDB_DO_Reader::~JuleaDB_DO_Reader()
{
...
size_t JuleaDB_DO_Reader::CurrentStep() const
{
...
void JuleaDB_DO_Reader::EndStep()
{
    if (m_Verbosity == 5)
    {
...
void JuleaDB_DO_Reader::PerformGets()
{
    if (m_Verbosity == 5)
    {
        std::cout << "Julea DB Reader " << m_ReaderRank
 ...
 */
// template <class T>
void JuleaDB_DO_Reader::InitVariables()
{

    InitVariablesFromDB_DO(m_Name, &m_IO, *this);
}

void JuleaDB_DO_Reader::InitParameters()
{
    if (m_Verbosity == 5)
    {
        std::cout << "Julea DB Reader " << m_ReaderRank
...
void JuleaDB_DO_Reader::InitTransports()
{
...
void JuleaDB_DO_Reader::DoClose(const int transportIndex)
{
    if (m_Verbosity == 5)
    {
