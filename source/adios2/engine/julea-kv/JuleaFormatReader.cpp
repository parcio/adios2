...
//     {
//         //FIXME: cannot be called right now
...
// AllStepsBlocksInfo(const core::Variable<T> &variable, std::string nameSpace)
// {
//     std::map<size_t, std::vector<typename core::Variable<T>::Info>>
//         allStepsBlocksInfo;
...
//             BlocksInfoCommon(variable, blockPositions, step - 1, nameSpace);
//     }
...
//                                 size_t step, std::string nameSpace)
// {
...
//                             const size_t step, std::string nameSpace)
// {
...
//     }
//     return BlocksInfoCommon(variable, itStep->second, step, nameSpace);
//     // return NULL;
// }
...
// template void DefineVariableInInitNew(core::IO *io, const std::string varName,\
    ...
    template void internalTest(typename core::Variable<T>::Info &info, gpointer buffer );\
