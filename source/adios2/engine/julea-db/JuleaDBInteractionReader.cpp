                    ...
                    bool isSingleValue)
{
    ...
    //     if (var)
    //     {
    //         std::cout << "Variable can be inquired " << std::endl;
    ...
    //             std::cout <<  "file: " << nameSpace << std::endl;
    ...
    //         std::cout << "maxField.c_str(): " << maxField.c_str() << std::endl;                     
    //         // float *min = 0;                                                            
    //         // float *max;                                                            
    //         int32_t *min = 0;                                                            
    //         int32_t *max;                                                            
    ...
    //         std::cout << "Here is some test output" << std::endl;
