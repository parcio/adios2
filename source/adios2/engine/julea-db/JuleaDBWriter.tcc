                                ...
                                const typename Variable<T>::Info &blockInfo)
{
    ...
    if (m_Verbosity == 5)
    {
        std::cout << "JuleaDB Writer " << m_WriterRank << "     PutSync("
                  << variable.m_Name << ")\n";
    }
    ...
    // std::cout << "++ JuleaDB Writer DEBUG PRINT blockInfo.Shape.size(): " <<
    ...
    // std::cout << "++ JuleaDB Writer DEBUG PRINT blockInfo.Start.size(): " <<
    ...
    // std::cout << "++ JuleaDB Writer DEBUG PRINT blockInfo.Count.size(): " <<
    ...
    PutVariableToJuleaDB(m_JuleaDBInfo->name_space, metadata, blockInfo.Data,
                       batch);
...
void JuleaDBWriter::PutSyncCommon(Variable<T> &variable, const T *data)
{
    ...
    PutVariableToJuleaDB(m_JuleaDBInfo->name_space, metadata, data, batch);
...
void JuleaDBWriter::PutDeferredCommon(Variable<T> &variable, const T *data)
{
    ...
    if (m_Verbosity == 5)
    {
        std::cout << "JuleaDB Writer " << m_WriterRank << "     PutDeferred("
                  << variable.m_Name << ")\n";
    }
