...
#ifndef ADIOS2_ENGINE_JuleaDBDAIREADER_H_
#define ADIOS2_ENGINE_JuleaDBDAIREADER_H_
...
class JuleaDBDAIReader : public Engine
{
public:
    /**
...
#endif /* ADIOS2_ENGINE_JuleaDBDAIREADER_H_ */
