        ...
        {                                                                      \
            ...
            {                                                                  \
                ...
                var->m_AvailableStepsCount++;                                  \
                                                                               ...
                                                                               \
            DAIsetMinMaxValueFields(&minField, &maxField, &valueField,            \
                                 &meanField, type);                            \
...
#define variable_template_instantiation(T)                                     \
    ...
    DAIDBGetBlockMetadata(const core::Variable<T> &variable, size_t entryID);     \
                                                                               \
    template void DAIDBGetVariableDataFromJulea(                                  \
...
//     template void DAIDBGetAttributeDataFromJulea(                                 \
