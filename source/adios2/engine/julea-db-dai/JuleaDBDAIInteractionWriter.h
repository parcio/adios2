...
#ifndef ADIOS2_ENGINE_JuleaDBDAIINTERACTIONWRITER_H_
#define ADIOS2_ENGINE_JuleaDBDAIINTERACTIONWRITER_H_
...
//         Variable<T> &variable, const T *data, const std::string nameSpace,     \
//         uint32_t entryID);                                                     \
//     extern template void DAIDBPutVariableMetadataToJulea(                         \
//         Variable<T> &variable, const std::string nameSpace,                    \
//         const std::string varName, size_t currStep, size_t block);             \
//     extern template void DAIDBPutBlockMetadataToJulea(                            \
//         Variable<T> &variable, const std::string nameSpace,                    \
