...
// // and other types
// template <class T>
// void DAIDBPutAttributeDataToJuleaSmall(Attribute<T> &attribute, const T *data,
//                                     const std::string nameSpace)
// {
...
// template <class T>
// void DAIDBPutAttributeDataToJulea(Attribute<T> &attribute,
//                                const std::string nameSpace)
// {
...
// template <>
// void DAIDBPutAttributeDataToJulea<std::string>(Attribute<std::string> &attribute,
//                                             const std::string nameSpace)
// {
//     // std::cout << "-- PutAttributeDataToJulea -------" << std::endl;
...
//     // std::cout << "++ Julea Interaction Writer: Put Attribute " << std::endl;
// }
//  template void DAIDBPutAttributeDataToJulea(Attribute<T> &attribute,           \
//                                             const std::string nameSpace);      \
//     template void DAIDBPutAttributeDataToJuleaSmall(                              \
//         Attribute<T> &attribute, const T *data, const std::string nameSpace);  \
//     template void DAIDBPutAttributeMetadataToJulea(Attribute<T> &attribute,       \
//                                                 bson_t *bsonMetaData,          \
//                                                 const std::string nameSpace);  \
//     template void DAIDBPutAttributeMetadataToJuleaSmall(                          \
//         Attribute<T> &attribute, bson_t *bsonMetaData,                         \
//         const std::string nameSpace);


#define declare_template_instantiation(T)                                      \
    template void DAIDBPutVariableDataToJulea(                                    \
