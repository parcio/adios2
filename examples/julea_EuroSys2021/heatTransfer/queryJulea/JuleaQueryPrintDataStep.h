...
#ifndef QUERYPRINTDATASTEP_H_
#define QUERYPRINTDATASTEP_H_
...
template <class T>
void QueryprintDataStep(double *xy, T *size, T *offset, int rank, int step)
{
    std::ofstream myfile;
